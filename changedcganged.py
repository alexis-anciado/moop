###iba yung pagibig at philhealth
...
class MyWindow:
    ...
    def calc(self):
        ...
        totalcontribution = (m_income * .045) + (m_income * .02) + 400.0
        taxableincome = m_income - totalcontribution
        if m_income <= 0:
            result = 0
        elif m_income <= 20833:
            result = taxableincome * .0
        elif m_income > 20833 or m_income <= 33332:
            result = taxableincome * .20
        elif m_income >= 33333 or m_income <= 66666:
            result = (taxableincome + 2500) * .25
        elif m_income >= 66667 or m_income <= 166666:
            result = (taxableincome + 10833.33) * .30
        elif m_income >= 166667 or m_income <= 666666:
            result = (taxableincome + 40833.33) * .32
        elif m_income >= 666667:
            result = (taxableincome + 200833.33) * .35
        ...
        if m_income <= 0:
            ...
            result = m_income - (taxableincome * .0)
        elif m_income >= 20833 or m_income <= 33332:
            result = m_income - (taxableincome * .20)
        elif m_income >= 33333 or m_income <= 66666:
            result = m_income - ((taxableincome + 2500) * .25)
        elif m_income >= 66667 or m_income <= 166666:
            result = m_income - ((taxableincome + 10833.33) * .30)
        elif m_income >= 166667 or m_income <= 666666:
            result = m_income - ((taxableincome + 40833.33) * .32)
        elif m_income >= 666667:
            result = m_income - ((taxableincome + 200833.33) * .35)
        ...
        if m_income <= 0:
            ...
            result = 400.0
        self.txt8.insert(END, str(result))
        self.txt8.config(state="readonly")
        ...
        if m_income <= 0:
            ...
            result = (m_income * .045) + (m_income * .01) + 400.0
        elif m_income:
            result = (m_income * .045) + (m_income * .02) + 400.0
        self.txt9.insert(END, str(result))
        self.txt9.config(state="readonly")
        ...
        if m_income <= 0:
            ...
            result = (m_income * .045) + (m_income * .01) + 400.0 + (((m_income * .045) + (m_income * .01) + 400.0) * .0)
        elif m_income >= 20833:
            result = totalcontribution + (taxableincome * .0)
        elif m_income >= 20833 or m_income <= 33332:
            result = totalcontribution + (taxableincome * .20)
        elif m_income >= 33333 or m_income <= 66666:
            result = totalcontribution + ((taxableincome + 2500) * .25)
        elif m_income >= 66667 or m_income <= 166666:
            result = totalcontribution + ((taxableincome + 10833.33) * .30)
        elif m_income >= 166667 or m_income <= 666666:
            result = totalcontribution + ((taxableincome + 40833.33) * .32)
        elif m_income >= 666667:
            result = totalcontribution + ((taxableincome + 200833.33) * .35)
        self.txt10.insert(END, str(result))
        self.txt10.config(state="readonly")
        ...
        m_income = float(self.txt2.get())
        totalcontribution = (m_income * .045) + (m_income * .015) + 100.0
        taxableincome = m_income - totalcontribution
        if m_income <= 0:
            result = 0
        elif m_income >= 1500:
            result = m_income - ((m_income * .045) + (m_income * .01) + 400.0 + (((m_income * .045) + (m_income * .01) + 400.0) * .0))
        elif m_income >= 20833:
            result = m_income - (totalcontribution + (taxableincome * .0))
        elif m_income >= 20834 or m_income <= 33332:
            result = m_income - (totalcontribution + (taxableincome * .20))
        elif m_income >= 33333 or m_income <= 66666:
            result = m_income - (totalcontribution + ((taxableincome + 2500) * .25))
        elif m_income >= 66667 or m_income <= 166666:
            result = m_income - (totalcontribution + ((taxableincome + 10833.33) * .30))
        elif m_income >= 166667 or m_income <= 666666:
            result = m_income - (totalcontribution + ((taxableincome + 40833.33) * .32))
        elif m_income >= 666667:
            result = m_income - (totalcontribution + ((taxableincome + 200833.33) * .35))
        self.txt11.insert(END, str(result))
        self.txt11.config(state="readonly")
